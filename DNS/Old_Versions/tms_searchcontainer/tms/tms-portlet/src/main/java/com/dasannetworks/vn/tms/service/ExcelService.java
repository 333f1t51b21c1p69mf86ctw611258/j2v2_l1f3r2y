...
public class ExcelService {
    ...
    public ImportDeviceListService.DeviceListInputFile parseDeviceList(File file) {
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook(file)){
            ...
            for (int i = 1; i < rowNum; i++) {
                ...
                ImportDeviceListService.DeviceListInputRow inputRow = new ImportDeviceListService.DeviceListInputRow
                        (factoryOut, productName, partNumber, qty, serialNumber, macAddress, viettelSerialNumber, cartonBoxSerial, manufacturerSerial);
                rows.add(inputRow);
            }
    ...
    public int findColumnIndex(XSSFSheet sheet, String columnName) {
