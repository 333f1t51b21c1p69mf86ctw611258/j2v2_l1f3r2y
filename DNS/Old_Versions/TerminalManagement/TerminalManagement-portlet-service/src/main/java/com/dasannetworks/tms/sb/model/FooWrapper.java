...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
    ...
    */
    ...
    @Override
    public int compareTo(com.dasannetworks.tms.sb.model.Foo foo) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.dasannetworks.tms.sb.model.Foo> toCacheModel() {
        return _foo.toCacheModel();
    }

    @Override
    public com.dasannetworks.tms.sb.model.Foo toEscapedModel() {
        return new FooWrapper(_foo.toEscapedModel());
    }

    @Override
    public com.dasannetworks.tms.sb.model.Foo toUnescapedModel() {
