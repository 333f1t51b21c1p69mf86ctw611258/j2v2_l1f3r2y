...
import com.dasannetworks.tms.sb.NoSuchDeviceException;
import com.dasannetworks.tms.sb.model.Device;
import com.dasannetworks.tms.sb.model.impl.DeviceImpl;
import com.dasannetworks.tms.sb.model.impl.DeviceModelImpl;
...
public class DevicePersistenceImpl extends BasePersistenceImpl<Device>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UPLOADFILEID =
        new FinderPath(DeviceModelImpl.ENTITY_CACHE_ENABLED,
            DeviceModelImpl.FINDER_CACHE_ENABLED, DeviceImpl.class,
            FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByUploadFileId",
            new String[] {
                Long.class.getName(),
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UPLOADFILEID =
        new FinderPath(DeviceModelImpl.ENTITY_CACHE_ENABLED,
            DeviceModelImpl.FINDER_CACHE_ENABLED, DeviceImpl.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUploadFileId",
            new String[] { Long.class.getName() },
            DeviceModelImpl.UPLOADFILEID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_UPLOADFILEID = new FinderPath(DeviceModelImpl.ENTITY_CACHE_ENABLED,
            DeviceModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUploadFileId",
            new String[] { Long.class.getName() });
    private static final String _FINDER_COLUMN_UPLOADFILEID_UPLOADFILEID_2 = "device.uploadFileId = ?";
     ...
     */
    @Override
    public List<Device> findByUploadFileId(long uploadFileId)
        throws SystemException {
        return findByUploadFileId(uploadFileId, QueryUtil.ALL_POS,
     ...
     */
    @Override
    public List<Device> findByUploadFileId(long uploadFileId, int start, int end)
        throws SystemException {
        return findByUploadFileId(uploadFileId, start, end, null);
    }
     ...
     */
    @Override
    public List<Device> findByUploadFileId(long uploadFileId, int start,
        ...
        if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
            ...
            pagination = false;
            finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UPLOADFILEID;
            finderArgs = new Object[] { uploadFileId };
        } else {
            finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_UPLOADFILEID;
        ...
        if ((list != null) && !list.isEmpty()) {
            for (Device device : list) {
                if ((uploadFileId != device.getUploadFileId())) {
                    list = null;
        ...
        if (list == null) {
            ...
            query.append(_FINDER_COLUMN_UPLOADFILEID_UPLOADFILEID_2);
     ...
     */
    @Override
    public Device findByUploadFileId_First(long uploadFileId,
        OrderByComparator orderByComparator)
        throws NoSuchDeviceException, SystemException {
        Device device = fetchByUploadFileId_First(uploadFileId,
                orderByComparator);
     ...
     */
    @Override
    public Device fetchByUploadFileId_First(long uploadFileId,
        OrderByComparator orderByComparator) throws SystemException {
        List<Device> list = findByUploadFileId(uploadFileId, 0, 1,
                orderByComparator);
     ...
     */
    @Override
    public Device findByUploadFileId_Last(long uploadFileId,
        OrderByComparator orderByComparator)
        throws NoSuchDeviceException, SystemException {
        Device device = fetchByUploadFileId_Last(uploadFileId, orderByComparator);
     ...
     */
    @Override
    public Device fetchByUploadFileId_Last(long uploadFileId,
        OrderByComparator orderByComparator) throws SystemException {
        int count = countByUploadFileId(uploadFileId);

        if (count == 0) {
            return null;
        }

        List<Device> list = findByUploadFileId(uploadFileId, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public Device[] findByUploadFileId_PrevAndNext(long deviceId,
        long uploadFileId, OrderByComparator orderByComparator)
        throws NoSuchDeviceException, SystemException {
        ...
        try {
            ...
            array[0] = getByUploadFileId_PrevAndNext(session, device,
                    uploadFileId, orderByComparator, true);

            array[1] = device;

            array[2] = getByUploadFileId_PrevAndNext(session, device,
                    uploadFileId, orderByComparator, false);
    ...
    protected Device getByUploadFileId_PrevAndNext(Session session,
        Device device, long uploadFileId, OrderByComparator orderByComparator,
        boolean previous) {
        StringBundler query = null;
    ...
    public void removeByUploadFileId(long uploadFileId)
        throws SystemException {
        for (Device device : findByUploadFileId(uploadFileId,
     ...
     */
    @Override
    public int countByUploadFileId(long uploadFileId) throws SystemException {
        FinderPath finderPath = FINDER_PATH_COUNT_BY_UPLOADFILEID;

        Object[] finderArgs = new Object[] { uploadFileId };
    ...
    @Override
    public Device updateImpl(com.dasannetworks.tms.sb.model.Device device)
        throws SystemException {
        device = toUnwrappedModel(device);
        ...
        if (isNew || !DeviceModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((deviceModelImpl.getColumnBitmask() &
                    FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UPLOADFILEID.getColumnBitmask()) != 0) {
                Object[] args = new Object[] {
                        deviceModelImpl.getOriginalUploadFileId()
                    };

                FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_UPLOADFILEID,
                    args);
                FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UPLOADFILEID,
                    args);

                args = new Object[] { deviceModelImpl.getUploadFileId() };
    ...
    protected Device toUnwrappedModel(Device device) {
        ...
        deviceImpl.setManufactureSerial(device.getManufactureSerial());
        ...
        deviceImpl.setUploadFileId(device.getUploadFileId());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.dasannetworks.tms.sb.model.Device")));
