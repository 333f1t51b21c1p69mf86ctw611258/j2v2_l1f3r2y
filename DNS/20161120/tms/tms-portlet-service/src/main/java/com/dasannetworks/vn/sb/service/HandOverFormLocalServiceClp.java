 ...
 * @generated
 */
public class HandOverFormLocalServiceClp implements HandOverFormLocalService {
    ...
    public HandOverFormLocalServiceClp(
    ...
    public com.dasannetworks.vn.sb.model.HandOverForm addHandOverForm(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(handOverForm) });
        } catch (Throwable t) {
        ...
        return (com.dasannetworks.vn.sb.model.HandOverForm) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.dasannetworks.vn.sb.model.HandOverForm createHandOverForm(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { handOverFormId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.dasannetworks.vn.sb.model.HandOverForm deleteHandOverForm(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { handOverFormId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.dasannetworks.vn.sb.model.HandOverForm fetchHandOverForm(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { handOverFormId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.dasannetworks.vn.sb.model.HandOverForm getHandOverForm(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { handOverFormId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.dasannetworks.vn.sb.model.HandOverForm> getHandOverForms(
        ...
        return (java.util.List<com.dasannetworks.vn.sb.model.HandOverForm>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.dasannetworks.vn.sb.model.HandOverForm> search(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName24,
                    ...
                    new Object[] { ClpSerializer.translateInput(searchInput) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
