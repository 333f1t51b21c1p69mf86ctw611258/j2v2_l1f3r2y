...
public class DeviceUtil {
    ...
    */
    ...
    /**
    * Returns all the devices where warrantyFormId = &#63;.
    *
    * @param warrantyFormId the warranty form ID
    * @return the matching devices
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.dasannetworks.vn.sb.model.Device> findByWarrantyFormId(
    ...
    /**
    * Returns a range of all the devices where warrantyFormId = &#63;.
    *
    * <p>
    * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.dasannetworks.vn.sb.model.impl.DeviceModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
    * </p>
    ...
    */
    ...
    /**
    * Returns an ordered range of all the devices where warrantyFormId = &#63;.
    *
    * <p>
    * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.dasannetworks.vn.sb.model.impl.DeviceModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
    * </p>
    ...
    */
    ...
    /**
    * Returns the first device in the ordered set where warrantyFormId = &#63;.
    *
    * @param warrantyFormId the warranty form ID
    * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
    * @return the first matching device
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device findByWarrantyFormId_First(
        java.lang.Long warrantyFormId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.dasannetworks.vn.sb.NoSuchDeviceException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device fetchByWarrantyFormId_First(
        java.lang.Long warrantyFormId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
    ...
    /**
    * Returns the last device in the ordered set where warrantyFormId = &#63;.
    *
    * @param warrantyFormId the warranty form ID
    * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
    * @return the last matching device
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device findByWarrantyFormId_Last(
        java.lang.Long warrantyFormId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.dasannetworks.vn.sb.NoSuchDeviceException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device fetchByWarrantyFormId_Last(
        java.lang.Long warrantyFormId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
    ...
    /**
    * Returns the devices before and after the current device in the ordered set where warrantyFormId = &#63;.
    *
    * @param deviceId the primary key of the current device
    * @param warrantyFormId the warranty form ID
    * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device[] findByWarrantyFormId_PrevAndNext(
    ...
    /**
    * Removes all the devices where warrantyFormId = &#63; from the database.
    *
    * @param warrantyFormId the warranty form ID
    * @throws SystemException if a system exception occurred
    */
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.dasannetworks.vn.sb.model.Device> findByCheckWarrantyInfo(
        java.lang.String serialNumber, java.lang.String macAddress)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().findByCheckWarrantyInfo(serialNumber, macAddress);
    }
    ...
    */
    public static java.util.List<com.dasannetworks.vn.sb.model.Device> findByCheckWarrantyInfo(
        ...
        return getPersistence()
                   .findByCheckWarrantyInfo(serialNumber, macAddress, start, end);
    }
    ...
    */
    public static java.util.List<com.dasannetworks.vn.sb.model.Device> findByCheckWarrantyInfo(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .findByCheckWarrantyInfo(serialNumber, macAddress, start,
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device findByCheckWarrantyInfo_First(
        java.lang.String serialNumber, java.lang.String macAddress,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.dasannetworks.vn.sb.NoSuchDeviceException,
            com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .findByCheckWarrantyInfo_First(serialNumber, macAddress,
            orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device fetchByCheckWarrantyInfo_First(
        java.lang.String serialNumber, java.lang.String macAddress,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .fetchByCheckWarrantyInfo_First(serialNumber, macAddress,
            orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device findByCheckWarrantyInfo_Last(
        java.lang.String serialNumber, java.lang.String macAddress,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.dasannetworks.vn.sb.NoSuchDeviceException,
            com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .findByCheckWarrantyInfo_Last(serialNumber, macAddress,
            orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device fetchByCheckWarrantyInfo_Last(
        java.lang.String serialNumber, java.lang.String macAddress,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .fetchByCheckWarrantyInfo_Last(serialNumber, macAddress,
            orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.dasannetworks.vn.sb.model.Device[] findByCheckWarrantyInfo_PrevAndNext(
        ...
        throws com.dasannetworks.vn.sb.NoSuchDeviceException,
            com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .findByCheckWarrantyInfo_PrevAndNext(deviceId, serialNumber,
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void removeByCheckWarrantyInfo(
        java.lang.String serialNumber, java.lang.String macAddress)
        throws com.liferay.portal.kernel.exception.SystemException {
        getPersistence().removeByCheckWarrantyInfo(serialNumber, macAddress);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int countByCheckWarrantyInfo(java.lang.String serialNumber,
        java.lang.String macAddress)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .countByCheckWarrantyInfo(serialNumber, macAddress);
    }
