...
/**
 * Provides the local service interface for RmaRequest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RmaRequestLocalServiceUtil
...
public interface RmaRequestLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link RmaRequestLocalServiceUtil} to access the rma request local service. Add custom service methods to {@link com.dasannetworks.vn.sb.service.impl.RmaRequestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
