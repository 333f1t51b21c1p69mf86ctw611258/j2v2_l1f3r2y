...
public class DeviceClp extends BaseModelImpl<Device> implements Device {
    ...
    public void setWarrantyFormId(Long warrantyFormId) {
        ...
        if (_deviceRemoteModel != null) {
            try {
                ...
                method.invoke(_deviceRemoteModel, warrantyFormId);
            } catch (Exception e) {
                throw new UnsupportedOperationException(e);
            }
        }
    ...
    public void setPurchaseOrder(
        ...
        try {
            String methodName = "setPurchaseOrder";

            Class<?>[] parameterTypes = new Class<?>[] {
                    com.dasannetworks.vn.sb.model.PurchaseOrder.class
                };

            Object[] parameterValues = new Object[] { purchaseOrder };
    ...
    public com.dasannetworks.vn.sb.model.PurchaseOrder fetchPurchaseOrder() {
        try {
            String methodName = "fetchPurchaseOrder";

            Class<?>[] parameterTypes = new Class<?>[] {  };

            Object[] parameterValues = new Object[] {  };

            com.dasannetworks.vn.sb.model.PurchaseOrder returnObj = (com.dasannetworks.vn.sb.model.PurchaseOrder) invokeOnRemoteModel(methodName,
    ...
    public java.util.Date getWarrantyEndDate() {
        try {
            String methodName = "getWarrantyEndDate";
    ...
    public com.dasannetworks.vn.sb.model.PurchaseOrder getPurchaseOrder() {
        try {
            String methodName = "getPurchaseOrder";
    ...
    public void setWarrantyForm(
        ...
        try {
            String methodName = "setWarrantyForm";

            Class<?>[] parameterTypes = new Class<?>[] {
                    com.dasannetworks.vn.sb.model.WarrantyForm.class
                };

            Object[] parameterValues = new Object[] { warrantyForm };
    ...
    public com.dasannetworks.vn.sb.model.WarrantyForm fetchWarrantyForm() {
        try {
            String methodName = "fetchWarrantyForm";

            Class<?>[] parameterTypes = new Class<?>[] {  };

            Object[] parameterValues = new Object[] {  };

            com.dasannetworks.vn.sb.model.WarrantyForm returnObj = (com.dasannetworks.vn.sb.model.WarrantyForm) invokeOnRemoteModel(methodName,
                    parameterTypes, parameterValues);
    ...
    public java.lang.String getPurchaseOrderNumber() {
        try {
            String methodName = "getPurchaseOrderNumber";
    ...
    public com.dasannetworks.vn.sb.model.WarrantyForm getWarrantyForm() {
        try {
            String methodName = "getWarrantyForm";
