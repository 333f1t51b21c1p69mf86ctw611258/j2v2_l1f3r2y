...
public class PurchaseOrderModelImpl extends BaseModelImpl<PurchaseOrder>
    ...
    public Object clone() {
        ...
        purchaseOrderImpl.setCustomerCode(getCustomerCode());
    ...
    public CacheModel<PurchaseOrder> toCacheModel() {
        ...
        purchaseOrderCacheModel.customerCode = getCustomerCode();

        String customerCode = purchaseOrderCacheModel.customerCode;

        if ((customerCode != null) && (customerCode.length() == 0)) {
            purchaseOrderCacheModel.customerCode = null;
        }
