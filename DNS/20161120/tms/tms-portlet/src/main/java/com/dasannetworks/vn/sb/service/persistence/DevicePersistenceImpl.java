...
public class DevicePersistenceImpl extends BasePersistenceImpl<Device>
     ...
     */
    @Override
    public List<Device> findByWarrantyFormId(Long warrantyFormId)
        throws SystemException {
     ...
     */
    @Override
    public List<Device> findByWarrantyFormId(Long warrantyFormId, int start,
        int end) throws SystemException {
     ...
     */
    @Override
    public Device findByWarrantyFormId_First(Long warrantyFormId,
        OrderByComparator orderByComparator)
        throws NoSuchDeviceException, SystemException {
        Device device = fetchByWarrantyFormId_First(warrantyFormId,
                orderByComparator);
     ...
     */
    @Override
    public Device fetchByWarrantyFormId_First(Long warrantyFormId,
        OrderByComparator orderByComparator) throws SystemException {
        List<Device> list = findByWarrantyFormId(warrantyFormId, 0, 1,
                orderByComparator);
     ...
     */
    @Override
    public Device findByWarrantyFormId_Last(Long warrantyFormId,
        OrderByComparator orderByComparator)
        throws NoSuchDeviceException, SystemException {
        Device device = fetchByWarrantyFormId_Last(warrantyFormId,
                orderByComparator);
     ...
     */
    @Override
    public Device fetchByWarrantyFormId_Last(Long warrantyFormId,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Device> list = findByWarrantyFormId(warrantyFormId, count - 1,
                count, orderByComparator);
     ...
     */
    @Override
    public Device[] findByWarrantyFormId_PrevAndNext(long deviceId,
        ...
        try {
            ...
            array[0] = getByWarrantyFormId_PrevAndNext(session, device,
                    warrantyFormId, orderByComparator, true);

            array[1] = device;

            array[2] = getByWarrantyFormId_PrevAndNext(session, device,
    ...
    protected Device getByWarrantyFormId_PrevAndNext(Session session,
        Device device, Long warrantyFormId,
        OrderByComparator orderByComparator, boolean previous) {
        StringBundler query = null;
    ...
    public void removeByWarrantyFormId(Long warrantyFormId)
        throws SystemException {
        for (Device device : findByWarrantyFormId(warrantyFormId,
                QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
            remove(device);
        }
    }
    ...
    public Device updateImpl(com.dasannetworks.vn.sb.model.Device device)
        ...
        if (isNew || !DeviceModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((deviceModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] {
                        deviceModelImpl.getOriginalWarrantyFormId()
                    };
                ...
                args = new Object[] { deviceModelImpl.getWarrantyFormId() };
