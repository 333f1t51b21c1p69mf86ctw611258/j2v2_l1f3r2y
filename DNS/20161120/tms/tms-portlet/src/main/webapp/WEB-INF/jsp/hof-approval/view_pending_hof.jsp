...
<liferay-portlet:renderURL varImpl="iteratorURL">
	<portlet:param name="mvcPath" value="/WEB-INF/jsp/hof-approval/view_pending_hof.jsp" />
...
<liferay-ui:search-container emptyResultsMessage="there-are-no-students" headerNames="HandOverForm Subject,Message, Status" iteratorURL="<%=iteratorURL%>" delta="10" deltaConfigurable="true">
	<liferay-ui:search-container-results>
		<%
			List<HandOverForm> handOverFormList = HandOverFormLocalServiceUtil.findByG_S(themeDisplay.getScopeGroupId(), WorkflowConstants.STATUS_DRAFT);
