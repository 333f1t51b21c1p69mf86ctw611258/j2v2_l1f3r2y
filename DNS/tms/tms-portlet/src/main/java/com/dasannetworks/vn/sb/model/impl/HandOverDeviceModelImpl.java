...
import com.dasannetworks.vn.sb.model.HandOverDeviceSoap;
...
public class HandOverDeviceModelImpl extends BaseModelImpl<HandOverDevice>
     ...
     */
    public static HandOverDevice toModel(HandOverDeviceSoap soapModel) {
        if (soapModel == null) {
            return null;
        }

        HandOverDevice model = new HandOverDeviceImpl();
        ...
        model.setFaultNote(soapModel.getFaultNote());
     ...
     */
    public static List<HandOverDevice> toModels(HandOverDeviceSoap[] soapModels) {
        if (soapModels == null) {
            return null;
        }

        List<HandOverDevice> models = new ArrayList<HandOverDevice>(soapModels.length);

        for (HandOverDeviceSoap soapModel : soapModels) {
