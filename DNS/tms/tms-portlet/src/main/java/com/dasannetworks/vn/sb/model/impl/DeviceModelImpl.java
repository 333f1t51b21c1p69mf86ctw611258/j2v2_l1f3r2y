...
public class DeviceModelImpl extends BaseModelImpl<Device>
    ...
    public static final Object[][] TABLE_COLUMNS = {
            ...
            { "manufacturerSerial", Types.VARCHAR },
    ...
    public static long SERIALNUMBER_COLUMN_BITMASK = 4L;
    ...
    public static Device toModel(DeviceSoap soapModel) {
        ...
        model.setManufacturerSerial(soapModel.getManufacturerSerial());
        ...
        model.setWarrantyStartDate(soapModel.getWarrantyStartDate());
        model.setWarrantyEndDate(soapModel.getWarrantyEndDate());
    ...
    public Object clone() {
        ...
        deviceImpl.setManufacturerSerial(getManufacturerSerial());
        ...
        deviceImpl.setWarrantyStartDate(getWarrantyStartDate());
        deviceImpl.setWarrantyEndDate(getWarrantyEndDate());
    ...
    public void resetOriginalValues() {
        ...
        deviceModelImpl._originalMacAddress = deviceModelImpl._macAddress;
    ...
    public CacheModel<Device> toCacheModel() {
        ...
        deviceCacheModel.manufacturerSerial = getManufacturerSerial();

        String manufacturerSerial = deviceCacheModel.manufacturerSerial;

        if ((manufacturerSerial != null) && (manufacturerSerial.length() == 0)) {
            deviceCacheModel.manufacturerSerial = null;
        }
        ...
        if (warrantyStartDate != null) {
            deviceCacheModel.warrantyStartDate = warrantyStartDate.getTime();
        } else {
            deviceCacheModel.warrantyStartDate = Long.MIN_VALUE;
        }

        Date warrantyEndDate = getWarrantyEndDate();

        if (warrantyEndDate != null) {
            deviceCacheModel.warrantyEndDate = warrantyEndDate.getTime();
        } else {
            deviceCacheModel.warrantyEndDate = Long.MIN_VALUE;
        }
