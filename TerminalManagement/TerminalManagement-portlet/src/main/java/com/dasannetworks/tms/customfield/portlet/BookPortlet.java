package com.dasannetworks.tms.customfield.portlet;
...
import com.dasannetworks.tms.customfield.util.ActionUtil;
import com.dasannetworks.tms.customfield.util.WebKeys;
...
public class BookPortlet extends MVCPortlet {
	...
	public void updateBook(ActionRequest actionRequest, ActionResponse actionResponse)
		 ...
		 * While calling update method we must have primary key in the passing
		 * object.
		 */
	...
	public void viewEdit(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		// Show edit_book.jsp
		actionResponse.setRenderParameter("jspPage", "/html/customfield/edit_book.jsp");
