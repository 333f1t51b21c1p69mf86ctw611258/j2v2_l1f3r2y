package com.dasannetworks.tms.thymeleafsample.controller;
...
import com.dasannetworks.tms.thymeleafsample.bean.SampleFormBean;
import com.dasannetworks.tms.thymeleafsample.util.LiferayUrlUtil;
...
/**
 * Spring Portlet MVC controller with samples of Action, Render & Resource
 * phases.
 * 
...
public class LiferayThymeleafPortletController {
	...
	public String defaultHandler(Model m, PortletRequest portletRequest, PortletResponse portletResponse) {
		...
		m.addAttribute("mySampleFormBean", new SampleFormBean("default value, henrik"));

		return "sample-portlet/sampleTemplate";
	}

	@ActionMapping(params = { "action=actionSample" })
	public void doActionSample(Model m, PortletRequest portletRequest, ActionResponse actionResponse,
			@ModelAttribute SampleFormBean mySampleFormBean,
			BindingResult result) {
		LOGGER.info("actionSample called " + mySampleFormBean);
	...
	public String doRenderActionSample(Model m, PortletRequest portletRequest, PortletResponse portletResponse) {
		LOGGER.info("renderSample called");
