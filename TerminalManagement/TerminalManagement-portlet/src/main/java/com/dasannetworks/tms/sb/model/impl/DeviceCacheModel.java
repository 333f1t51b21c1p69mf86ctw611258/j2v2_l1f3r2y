...
public class DeviceCacheModel implements CacheModel<Device>, Externalizable {
    ...
    public String manufactureSerial;
    ...
    public Device toEntityModel() {
        ...
        if (manufactureSerial == null) {
            deviceImpl.setManufactureSerial(StringPool.BLANK);
        } else {
            deviceImpl.setManufactureSerial(manufactureSerial);
        }
        ...
        deviceImpl.setUploadFileId(uploadFileId);
    ...
    public void readExternal(ObjectInput objectInput) throws IOException {
        ...
        manufactureSerial = objectInput.readUTF();
    ...
    public void writeExternal(ObjectOutput objectOutput)
        ...
        if (manufactureSerial == null) {
            ...
            objectOutput.writeUTF(manufactureSerial);
        }
