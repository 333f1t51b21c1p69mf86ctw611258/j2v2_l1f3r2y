...
public class FeedbackWrapper implements Feedback, ModelWrapper<Feedback> {
    ...
    */
    ...
    @Override
    public int compareTo(com.dasannetworks.tms.sb.model.Feedback feedback) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.dasannetworks.tms.sb.model.Feedback> toCacheModel() {
        return _feedback.toCacheModel();
    }

    @Override
    public com.dasannetworks.tms.sb.model.Feedback toEscapedModel() {
        return new FeedbackWrapper(_feedback.toEscapedModel());
    }

    @Override
    public com.dasannetworks.tms.sb.model.Feedback toUnescapedModel() {
