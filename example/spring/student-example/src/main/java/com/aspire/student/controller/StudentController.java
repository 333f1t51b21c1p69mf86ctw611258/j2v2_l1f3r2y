...
public class StudentController {
	...
	public void saveStudent(ActionRequest actionRequest, ActionResponse actionResponse, Model model,
			@ModelAttribute("student") Student student, BindingResult result) throws IOException, PortletException {
	...
	public void searchStudents(@RequestParam("quertString") String queryString, ResourceRequest request,
