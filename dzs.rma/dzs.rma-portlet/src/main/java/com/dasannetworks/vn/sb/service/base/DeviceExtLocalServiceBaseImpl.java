...
import com.dasannetworks.vn.sb.service.DeviceExtLocalService;
...
/**
 * Provides the base implementation for the device ext local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dasannetworks.vn.sb.service.impl.DeviceExtLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dasannetworks.vn.sb.service.impl.DeviceExtLocalServiceImpl
 * @see com.dasannetworks.vn.sb.service.DeviceExtLocalServiceUtil
 * @generated
 */
public abstract class DeviceExtLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements DeviceExtLocalService, IdentifiableBean {
    ...
    private DeviceExtLocalServiceClpInvoker _clpInvoker = new DeviceExtLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.dasannetworks.vn.sb.service.DeviceExtLocalServiceUtil} to access the device ext local service.
     */
    ...
    @Override
    public DeviceExt addDeviceExt(DeviceExt deviceExt)
        throws SystemException {
        deviceExt.setNew(true);

        return deviceExtPersistence.update(deviceExt);
    }
     ...
     */
    @Override
    public DeviceExt createDeviceExt(long deviceExtId) {
        return deviceExtPersistence.create(deviceExtId);
    }
    ...
    @Override
    public DeviceExt deleteDeviceExt(long deviceExtId)
        throws PortalException, SystemException {
        return deviceExtPersistence.remove(deviceExtId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public DeviceExt deleteDeviceExt(DeviceExt deviceExt)
        throws SystemException {
        return deviceExtPersistence.remove(deviceExt);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(DeviceExt.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return deviceExtPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return deviceExtPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return deviceExtPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public DeviceExt fetchDeviceExt(long deviceExtId) throws SystemException {
        return deviceExtPersistence.fetchByPrimaryKey(deviceExtId);
    }
     ...
     */
    @Override
    public DeviceExt getDeviceExt(long deviceExtId)
        throws PortalException, SystemException {
        return deviceExtPersistence.findByPrimaryKey(deviceExtId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return deviceExtPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<DeviceExt> getDeviceExts(int start, int end)
        throws SystemException {
        return deviceExtPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getDeviceExtsCount() throws SystemException {
        return deviceExtPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public DeviceExt updateDeviceExt(DeviceExt deviceExt)
        throws SystemException {
        return deviceExtPersistence.update(deviceExt);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.dasannetworks.vn.sb.model.DeviceExt",
            deviceExtLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = deviceExtPersistence.getDataSource();
