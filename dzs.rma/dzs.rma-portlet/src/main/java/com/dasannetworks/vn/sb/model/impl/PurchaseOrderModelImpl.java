...
public class PurchaseOrderModelImpl extends BaseModelImpl<PurchaseOrder>
    ...
    public static final String TABLE_SQL_CREATE = "create table tms_PurchaseOrder (purchaseOrderId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,customerId LONG,signDate DATE null,warrantyStartDate DATE null,warrantyEndDate DATE null,purchaseOrderNumber VARCHAR(75) null)";
    ...
    public static long PURCHASEORDERNUMBER_COLUMN_BITMASK = 2L;
    public static long PURCHASEORDERID_COLUMN_BITMASK = 4L;
    ...
    public Object clone() {
        ...
        purchaseOrderImpl.setCustomerId(getCustomerId());
        purchaseOrderImpl.setSignDate(getSignDate());
        purchaseOrderImpl.setWarrantyStartDate(getWarrantyStartDate());
        purchaseOrderImpl.setWarrantyEndDate(getWarrantyEndDate());
    ...
    public void resetOriginalValues() {
        ...
        purchaseOrderModelImpl._originalCustomerId = purchaseOrderModelImpl._customerId;

        purchaseOrderModelImpl._setOriginalCustomerId = false;
    ...
    public CacheModel<PurchaseOrder> toCacheModel() {
        ...
        purchaseOrderCacheModel.customerId = getCustomerId();
        ...
        if (warrantyStartDate != null) {
            purchaseOrderCacheModel.warrantyStartDate = warrantyStartDate.getTime();
        } else {
            purchaseOrderCacheModel.warrantyStartDate = Long.MIN_VALUE;
        }

        Date warrantyEndDate = getWarrantyEndDate();

        if (warrantyEndDate != null) {
            purchaseOrderCacheModel.warrantyEndDate = warrantyEndDate.getTime();
        } else {
            purchaseOrderCacheModel.warrantyEndDate = Long.MIN_VALUE;
        }
