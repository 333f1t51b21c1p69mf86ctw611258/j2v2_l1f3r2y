...
public class PurchaseOrderWrapper implements PurchaseOrder,
    ...
    */
    ...
    /**
    * Returns the customer ID of this purchase order.
    *
    * @return the customer ID of this purchase order
    */
    @Override
    public java.lang.Long getCustomerId() {
        return _purchaseOrder.getCustomerId();
    }

    /**
    * Sets the customer ID of this purchase order.
    *
    * @param customerId the customer ID of this purchase order
    */
    @Override
    public void setCustomerId(java.lang.Long customerId) {
        _purchaseOrder.setCustomerId(customerId);
    }
