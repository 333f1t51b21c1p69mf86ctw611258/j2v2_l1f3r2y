...
/**
 * Provides the local service interface for DeviceExt. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DeviceExtLocalServiceUtil
...
public interface DeviceExtLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link DeviceExtLocalServiceUtil} to access the device ext local service. Add custom service methods to {@link com.dasannetworks.vn.sb.service.impl.DeviceExtLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
