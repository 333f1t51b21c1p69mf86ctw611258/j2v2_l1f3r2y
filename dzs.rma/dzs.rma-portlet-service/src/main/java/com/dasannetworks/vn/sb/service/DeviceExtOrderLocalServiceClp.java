 ...
 * @generated
 */
public class DeviceExtOrderLocalServiceClp implements DeviceExtOrderLocalService {
    ...
    public DeviceExtOrderLocalServiceClp(
    ...
    public com.dasannetworks.vn.sb.model.DeviceExtOrder addDeviceExtOrder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(deviceExtOrder) });
        } catch (Throwable t) {
        ...
        return (com.dasannetworks.vn.sb.model.DeviceExtOrder) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.dasannetworks.vn.sb.model.DeviceExtOrder createDeviceExtOrder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { deviceExtOrderId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.dasannetworks.vn.sb.model.DeviceExtOrder deleteDeviceExtOrder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { deviceExtOrderId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.dasannetworks.vn.sb.model.DeviceExtOrder fetchDeviceExtOrder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { deviceExtOrderId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.dasannetworks.vn.sb.model.DeviceExtOrder getDeviceExtOrder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { deviceExtOrderId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.dasannetworks.vn.sb.model.DeviceExtOrder> getDeviceExtOrders(
        ...
        return (java.util.List<com.dasannetworks.vn.sb.model.DeviceExtOrder>) ClpSerializer.translateOutput(returnObj);
    }
