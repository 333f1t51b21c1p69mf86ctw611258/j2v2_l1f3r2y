...
/**
 * Provides the local service interface for DeviceHis. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DeviceHisLocalServiceUtil
...
public interface DeviceHisLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link DeviceHisLocalServiceUtil} to access the device his local service. Add custom service methods to {@link com.dasannetworks.vn.sb.service.impl.DeviceHisLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
