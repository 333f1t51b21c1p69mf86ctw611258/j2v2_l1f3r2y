 ...
 * @generated
 */
public class DeviceExtSoap implements Serializable {
    ...
    public DeviceExtSoap() {
    }

    public static DeviceExtSoap toSoapModel(DeviceExt model) {
        DeviceExtSoap soapModel = new DeviceExtSoap();
    ...
    public static DeviceExtSoap[] toSoapModels(DeviceExt[] models) {
        DeviceExtSoap[] soapModels = new DeviceExtSoap[models.length];
    ...
    public static DeviceExtSoap[][] toSoapModels(DeviceExt[][] models) {
        DeviceExtSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new DeviceExtSoap[models.length][models[0].length];
        } else {
            soapModels = new DeviceExtSoap[0][0];
        }
    ...
    public static DeviceExtSoap[] toSoapModels(List<DeviceExt> models) {
        List<DeviceExtSoap> soapModels = new ArrayList<DeviceExtSoap>(models.size());

        for (DeviceExt model : models) {
            soapModels.add(toSoapModel(model));
        }

        return soapModels.toArray(new DeviceExtSoap[soapModels.size()]);
    }
