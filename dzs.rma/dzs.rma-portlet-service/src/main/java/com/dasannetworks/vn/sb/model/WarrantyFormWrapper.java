...
public class WarrantyFormWrapper implements WarrantyForm,
    ...
    */
    ...
    /**
    * Returns the agent code of this warranty form.
    *
    * @return the agent code of this warranty form
    */
    @Override
    public java.lang.String getAgentCode() {
        return _warrantyForm.getAgentCode();
    }

    /**
    * Sets the agent code of this warranty form.
    *
    * @param agentCode the agent code of this warranty form
    */
    @Override
    public void setAgentCode(java.lang.String agentCode) {
        _warrantyForm.setAgentCode(agentCode);
    }
    ...
    */
    ...
    /**
    * Returns the original serial number of this warranty form.
    *
    * @return the original serial number of this warranty form
    */
    @Override
    public java.lang.String getOriginalSerialNumber() {
        return _warrantyForm.getOriginalSerialNumber();
    }

    /**
    * Sets the original serial number of this warranty form.
    *
    * @param originalSerialNumber the original serial number of this warranty form
    */
    @Override
    public void setOriginalSerialNumber(java.lang.String originalSerialNumber) {
        _warrantyForm.setOriginalSerialNumber(originalSerialNumber);
    }

    /**
    * Returns the his serial numbers of this warranty form.
    *
    * @return the his serial numbers of this warranty form
    */
    @Override
    public java.lang.String getHisSerialNumbers() {
        return _warrantyForm.getHisSerialNumbers();
    }

    /**
    * Sets the his serial numbers of this warranty form.
    *
    * @param hisSerialNumbers the his serial numbers of this warranty form
    */
    @Override
    public void setHisSerialNumbers(java.lang.String hisSerialNumbers) {
        _warrantyForm.setHisSerialNumbers(hisSerialNumbers);
    }

    /**
    * Returns the latest serial number of this warranty form.
    *
    * @return the latest serial number of this warranty form
    */
    @Override
    public java.lang.String getLatestSerialNumber() {
        return _warrantyForm.getLatestSerialNumber();
    }

    /**
    * Sets the latest serial number of this warranty form.
    *
    * @param latestSerialNumber the latest serial number of this warranty form
    */
    @Override
    public void setLatestSerialNumber(java.lang.String latestSerialNumber) {
        _warrantyForm.setLatestSerialNumber(latestSerialNumber);
    }
